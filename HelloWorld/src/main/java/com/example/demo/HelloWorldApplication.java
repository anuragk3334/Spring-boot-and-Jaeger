...
public class HelloWorldApplication {
	...
	public io.opentracing.Tracer init() {
		 ...
		 * ReporterConfiguration.fromEnv().withLogSpans(true); Configuration config =
		 * Configuration.fromEnv("boot-service-a").withSampler(samplerConfig).
		 * withReporter(reporterConfig); return config.getTracer();
		 */
